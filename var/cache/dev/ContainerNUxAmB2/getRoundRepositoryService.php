 ...
 */
class getRoundRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoundRepository' shared autowired service.
     *
     * @return \App\Repository\RoundRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoundRepository.php';

        return $container->privates['App\\Repository\\RoundRepository'] = new \App\Repository\RoundRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

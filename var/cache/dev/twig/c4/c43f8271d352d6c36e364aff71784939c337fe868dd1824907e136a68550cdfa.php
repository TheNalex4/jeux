...
class __TwigTemplate_0201106d7a6759a32aa4529cf332fd5d083b8551d45365205ffd793fbc375be9 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    <div>";
        // line 31
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "birthday", [], "any", false, false, false, 31), "m/d/Y"), "html", null, true);
        echo "</div>
    <br><br>
    <button type=\"submit\" class=\"btn btn-success\"><a id=\"mod\" href=\"";
        // line 33
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_modification");
...
";
    ...
    {
        return array (  164 => 33,  159 => 31,  152 => 27,  146 => 24,  140 => 21,  130 => 15,  121 => 13,  117 => 12,  114 => 11,  104 => 10,  85 => 8,  70 => 4,  60 => 3,  37 => 1,);
    }
...
<h1>Bonjour {{ user.firstName }}</h1>
    ...
    <br>
    <strong>Date de naissance:</strong>
    <div>{{ user.birthday|date(\"m/d/Y\")}}</div>
    <br><br>
    <button type=\"submit\" class=\"btn btn-success\"><a id=\"mod\" href=\"{{ path('app_modification') }}\">modifier le profil</a></button>

{% endblock %}
", "user/index.html.twig", "C:\\wamp64\\www\\pasdequartier\\pasdequartier\\templates\\user\\index.html.twig");
    }
}
